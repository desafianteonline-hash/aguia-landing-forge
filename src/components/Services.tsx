    ...
    <section id="servicos" className="px-5 py-14 md:px-4 md:py-28 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-10 flex flex-col gap-4 md:mb-14 md:flex-row md:items-end md:justify-between">
          <h2 className="text-2xl font-bold leading-tight text-foreground md:max-w-md md:text-4xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="flex flex-col justify-center rounded-2xl bg-primary/10 p-6 md:p-8">
            <span className="mb-3 text-sm font-bold text-secondary">01</span>
          ...
          {/* Card 02 - bottom left */}
          <div className="flex flex-col justify-center rounded-2xl bg-primary/10 p-6 md:p-8">
            <span className="mb-3 text-sm font-bold text-secondary">02</span>
            <h3 className="mb-2 text-lg font-bold text-foreground md:text-xl">
          ...
          <div className="flex flex-col justify-center rounded-2xl bg-primary/10 p-6 md:p-8">
            <span className="mb-3 text-sm font-bold text-secondary">03</span>
            <h3 className="mb-2 text-lg font-bold text-foreground md:text-xl">
